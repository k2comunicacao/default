  ...
  <link rel="icon" href="<?php bloginfo('template_url'); ?>/favicon.png" sizes="32x32" />
  ...
  <link rel="apple-touch-icon" sizes="114x114" href="<?php bloginfo('template_url'); ?>/img/img/apple-touch-icon-114x114.png" />
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="<?php bloginfo('template_url'); ?>/img/apple-touch-icon-180x180.png" />
